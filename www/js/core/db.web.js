/* ===== DB WRAPPER (IndexedDB) — mode WEB/PWA ===== */
// Ini implementasi ASLI (sebelumnya bernama db.js). Sekarang dipakai khusus
// saat app jalan di browser biasa (bukan APK Capacitor), supaya development
// & testing masih bisa langsung buka index.html di browser tanpa perlu
// native SQLite. Lihat js/core/db.js untuk dispatcher yang milih implementasi
// ini vs db.native.js.
export const DB = {
  _db: null,
